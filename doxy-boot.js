...
$( document ).ready(function() {
  /* 
     Description:
     Fills the search box dropdown.

     Know bug:
     This method doesn't show any item in the dropbown
     in pages where source code is injected if doxygen
     'source browser -> inline_sources' is enabled.

     This block is not reachable in that scenario. 
     You can check it writing console.log("echo");

     I don't think this can be solved right now. 
     Doxygen is injecting something that prevents 
     $(document).ready to be executed. 
     Luckily this is an insignificant bug.
  */
